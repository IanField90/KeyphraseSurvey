<html>
	...
	<body>
		...
		//	$row = mysql_fetch_array($result, MYSQL_ASSOC)
			...
			$body = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam id mauris arcu. Nam mollis tellus vel turpis facilisis et aliquet velit ultricies. Suspendisse elit nibh, elementum a faucibus eu, eleifend vitae quam. Sed vitae tellus quis libero scelerisque vehicula tempus at elit. Nullam ac lectus nunc. Mauris eget dui dui. Curabitur est ipsum, tincidunt nec rhoncus eget, vehicula et ligula. Vestibulum lectus tellus, mollis ac molestie eu, ornare sit amet tellus. Aliquam sed aliquam justo. In a felis eros, at molestie purus."; //$row['Corpus_Body'];
			$keywords = array("Alpha", "Bravo", "Charlie", "Delta", "Echo", "Foxtrot", "Golf", "Hotel", "Indigo", "Juliette", "Kilo", "Leema", "Mike", "November", "Oscar"); //array($row['A1'], $row['A2'], $row['A3'], $row['A4'], $row['A5'], $row['B1'], $row['B2'], $row['B3'], $row['B4'], $row['B5'], $row['C1'], $row['C2'], $row['C3'], $row['C4'], $row['C5']);
			...
			echo '<input type="radio" name="inputChoice" />Select options from bellow.';
		...
		<p />
		<input type="radio" name="inputChoice" />None of the above.
		<p />
		<input type="button" value="Submit" id="subButton" onClick="myFunction()"/>
		</form>
	</body>
</html>
